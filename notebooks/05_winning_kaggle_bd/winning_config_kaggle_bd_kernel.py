...
WINNING_CONFIG = [
    ("winning", True, True, 0.3, MARGIN, 2.0, 3),
]
...
def save_summary():
    pd.DataFrame(summary_rows).to_csv(os.path.join(OUTPUT_ROOT, "summary_winning_kaggle_bd.csv"), index=False)
...
print("\n=== SUMMARY WINNING CONFIG ON KAGGLE-BD ===")
