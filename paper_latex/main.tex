...
\paragraph{Data availability.} All training, evaluation, and analysis code is released on GitHub, in a repository independent of the prior project that motivated this study: \url{https://github.com/bangdang-ai-developer/ocr-lasa-safety}, archived at Zenodo under DOI \url{https://doi.org/10.5281/zenodo.22912562} (release v1.0.0), which corresponds exactly to the code and results reported here.
